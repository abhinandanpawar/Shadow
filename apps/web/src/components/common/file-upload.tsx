...
// The API endpoint for the standalone ATS service
const API_RESUME_UPLOAD_URL = `http://localhost:8000/api/v1/resume/upload`;
...
export default function FileUpload() {
	...
	const [
		...
		onUploadSuccess: (uploadedFile, response) => {
			...
			// Redirect to the new dashboard path within the host application
			window.location.href = `/ats/dashboard?resume_id=${encodedResumeId}`;
		},
